...
<head>
  ...
  <script type="text/javascript" src="../Dashboard/app.js" defer></script>
</head>
<body>
<nav id="sidebar">
    <ul>
  ...
  <main>
    ...
    <div class="top">
      <h1>Tabel Siswa</h1>
      <a href="../siswa/tambah.php">Tambah</a>
    </div>
    <table>
        <tr>
            <th>NIS</th>
      ...
      while($row = mysqli_fetch_array($data)){
        ...
        <tr>
            ...
            <td><a href="edit-siswa.php?nis=<?php echo $row['NIS']; ?>">edit</a>
            <a href="hapus-siswa.php" onclick="confirmDelete (<?php echo $row['NIS']; ?>, event)">Hapus</a>      
          </td>
        </tr>
    <?php
      }
